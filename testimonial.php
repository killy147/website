        ...
        <nav class="navbar navbar-expand-lg bg-white navbar-light py-0 px-4">
          ...
          <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav ms-auto">
              ...
              <a href="testimonial.php" class="nav-item nav-link active"
                >Testimoni</a
              >
      ...
      <div class="container-fluid header bg-white p-0">
        <div class="row g-0 align-items-center flex-column-reverse flex-md-row">
          <div class="col-md-6 p-5 mt-lg-5">
            <h1 class="display-5 animated fadeIn mb-4">Testimoni</h1>
      ...
      <div class="container-xxl py-5">
        <div class="container">
          ...
          >
            ...
            <p>
              Review yang diberikan oleh para penyewa yang sudah menyewa kos di
              Kos Ibu Tetty
            </p>
          </div>
          <div
          ...
          <div class="row g-5">
            ...
            <div class="col-lg-3 col-md-6">
              ...
              <?php
                  ...
                  >
                    <?php endforeach ?>
              <a class="btn btn-link text-white-50" href="contact.php"
                >Kontak</a
              >
            </div>
            <div class="col-lg-3 col-md-6">
